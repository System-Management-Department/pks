...
{block name="body"}
<form action="{url action="update" id=$data.id}" method="POST" class="container-fluid row" data-master="ターゲットマスター">
	<label for="e{counter skip=0}" class="col-12 form-label">ターゲット名称<span class="badge bg-danger">必須</span></label>
