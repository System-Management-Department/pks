...
<form action="{url action="regist"}" method="POST" class="container-fluid row" data-master="クライアントマスター">
	...
	<div class="col-12 col-md-6 col-lg-5">
		<input type="text" name="zip" id="e{counter skip=1}" class="form-control" placeholder="入力してください"></textarea>
		<div class="invalid-feedback"></div>
	</div>
	
	<label for="e{counter skip=0}" class="col-12 mt-5 form-label">都道府県（必須）</label>
	<div class="col-12 col-md-6 col-lg-5">
		<input type="text" name="address1" id="e{counter skip=1}" class="form-select" placeholder="選択"></textarea>
		<div class="invalid-feedback"></div>
	</div>
	
	<label for="e{counter skip=0}" class="col-12 mt-5 form-label">市区町村・番地（必須）</label>
	<div class="col-12 col-lg-10">
		<input type="text" name="address2" id="e{counter skip=1}" class="form-control" placeholder="入力してください"></textarea>
		<div class="invalid-feedback"></div>
	</div>
	
	<label for="e{counter skip=0}" class="col-12 mt-5 form-label">建物名・号室（任意）</label>
	<div class="col-12 col-lg-10">
		<input type="text" name="address3" id="e{counter skip=1}" class="form-control" placeholder="入力してください"></textarea>
		<div class="invalid-feedback"></div>
	</div>
